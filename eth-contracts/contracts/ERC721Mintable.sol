...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerToken, "require the given address to not be the owner of the tokenId");

        require(ownerToken == msg.sender || isApprovedForAll(ownerToken, msg.sender), "msg sender not the owner of the contract or not approved for all");
        _tokenApprovals[tokenId] = to;
        

        emit Approval(ownerToken, to, tokenId);
    }
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "to not msg.sender");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "Owner needs to be approved");
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(to != address(0), 'not allowed to mint to 0 address');
...
contract ERC721Metadata is ERC721Enumerable {
    ...
    function setTokenURI(uint256 tokenId) public{
        require(_exists(tokenId), "Token id does not exist");
        string memory newURI = string(abi.encodePacked(this.getBaseTokenURI(), tokenId.toString()));        
...
contract CustomERC721Token is ERC721Metadata{
        ...
        constructor() ERC721Metadata("Real Estate Token", 
                                     "RET", 
